        ...
        <div className="bg-slate-800/90 border border-slate-700/80 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg backdrop-blur-md">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full bg-slate-900/80 border border-slate-700 rounded-xl py-2.5 pl-10 pr-4 text-xs .text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500"
            />
          </div>

          <button
            onClick={handleOpenAddModal}
            className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold px-4 py-2.5 rounded-xl text-xs flex items-center gap-2 cursor-pointer shadow-md transition-all shrink-0"
          >
        ...
        <div className="space-y-4">
          {filteredCareers.map((job) => (
            <motion.div
              ...
              className="bg-slate-800/90 border border-slate-700/80 rounded-3xl p-6 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6 hover:border-amber-500/60 transition-all"
            >
              <div className="space-y-3 max-w-3xl">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="bg-amber-950 text-amber-300 text-[10px] font-extrabold uppercase tracking-wider px-3 py-0.5 rounded-full border border-amber-800">
                    {job.department}
                  </span>
                  <span className="text-xs font-semibold text-slate-400 bg-slate-900 px-3 py-0.5 rounded-full border border-slate-700 flex items-center gap-1">
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400 pt-1 font-mono">
                  ...
                  {job.salary && (
                    <>
                      <span>•</span>
                      <span className="text-emerald-400 font-bold"><strong>Salary:</strong> {job.salary}</span>
                    </>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0 self-end md:self-center">
                <button
                  ...
                  className="px-3 py-2 bg-slate-700 text-slate-200 hover:text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:ring-2 focus:ring-amber-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none font-mono"
                    />
                  </div>
