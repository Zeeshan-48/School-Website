  ...
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen">
      ...
      <PageHeader
        ...
        heightClass="h-[160px] sm:h-[200px] lg:h-[250px]"
      />
              ...
              return (
                <motion.button
                  ...
                  className={`px-5 py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all cursor-pointer ${isActive
                    ...
                    : 'bg-slate-800 text-white hover:bg-[#166534] border border-slate-700 hover:border-lime-500/50'
                    }`}
                >
                  {cat.name}
                </motion.button>
                ...
                {filteredItems.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-5 left-5 right-5 text-white space-y-1.5">
                      <h3 className="font-poppins text-lg font-bold text-white leading-snug group-hover:text-lime-400 transition-colors">
                        {item.title}
                      </h3>
                      <p className="font-inter text-xs text-white line-clamp-2">
                        {item.caption}
                      </p>
                    </div>
                  </motion.div>
