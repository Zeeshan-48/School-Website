  ...
  const stats = [
    {
      ...
      count: statsData?.totalInquiries || 0,
      badge: `${statsData?.newInquiries || 0} New`,
    ...
    },
    {
      ...
      count: statsData?.totalAdmissions || 0,
      badge: `${statsData?.pendingAdmissions || 0} Pending`,
      badgeColor: 'bg-emerald-100 text-black border border-emerald-200',
    ...
    },
    {
      ...
      count: statsData?.totalApplicants || 0,
      badge: `${statsData?.newApplicants || 0} New Candidates`,
      badgeColor: 'bg-emerald-100 text-black border border-emerald-200',
      icon: UserCheck,
    ...
    },
    {
      ...
      count: statsData?.totalFaculty || 0,
      badge: 'Active Staff',
      badgeColor: 'bg-emerald-100 text-black border border-emerald-200',
      icon: Users,
    ...
    {
      title: 'Job Openings',
      count: statsData?.totalCareers || 0,
      badge: 'Careers CMS',
      badgeColor: 'bg-emerald-100 text-black border border-emerald-200',
      icon: Briefcase,
    ...
    {
      title: 'Gallery Media',
      count: statsData?.totalGalleryItems || 0,
      badge: 'Media Assets',
      badgeColor: 'bg-emerald-100 text-black border border-emerald-200',
      icon: ImageIcon,
