...
export const PageHeader = ({ icon: Icon, badge, title, subtitle, bgImage, imagePosition = "object-[center_35%]", heightClass = "h-[220px] sm:h-[280px] lg:h-[350px]" }) => {
  const defaultBg = IMAGES.banners.home;
  const fallbackBg = getFallbackUrl(['indian', 'school', 'header']);

  return (
    <section className="relative w-full mt-19 bg-slate-950 py-8 sm:py-10 overflow-hidden border-b border-emerald-900/40 group">
 ...
 className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center ${heightClass}`}
 >
 {badge && (
