...
export const AboutSchool = () => {
    ...
    return (
        <section className="pt-16 pb-10 sm:pt-20 sm:pb-12 bg-slate-50 relative overflow-hidden">
                    ...
                    >
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-poppins text-xl sm:text-2xl font-black text-white">25+ <span className="text-lime-400 text-sm sm:text-base">Years</span></h4>
                                    <p className="font-inter text-[10px] sm:text-xs text-green-100/90 mt-0.5 leading-relaxed">Of Educational Leadership & Academic Glory</p>
                                </div>
                            </div>
                        </motion.div>
