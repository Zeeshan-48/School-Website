...
export const Hero = () => {
    ...
    return (
        ...
        // min-h-[calc(100vh-76px)] ensures a full screen banner profile.
        <section className="relative w-full bg-slate-950 mt-[/6px] min-h-[calc(100vh-76px)] flex items-center overflow-hidden">
